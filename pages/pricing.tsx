...
export const frequencies: PricingTierFrequency[] = [
  { id: "1", value: "1", label: "1 Mes", priceSuffix: "/month" },
  { id: "2", value: "2", label: "6 Meses", priceSuffix: "/year" },
  { id: "3", value: "3", label: "12 Meses", priceSuffix: "/quarter" },
];
...
export const tiers: PricingTier[] = [
  {
    ...
    id: "0",
    href: "/subscribe",
    price: { "1": "$1,200", "2": "$6,000", "3": "$11,000" },
    discountPrice: { "1": "", "2": "", "3": "" },
                ...
                <p className="mt-6 flex items-baseline gap-x-1">
                  <span
                    className={cn(
                      ...
                      tier.discountPrice[frequency.value] // Type guard added
                        ? "line-through"
                        : ""
                    )}
                  >
                    {typeof tier.price === "string"
                      ...
                      : typeof tier.price === 'object' && 
                        tier.price[frequency.value] // Type guard added
